...
teal=material('V3 / chipped petrol armor','3B5861',.73,.39,wear=True)
teal2=material('V3 / edge armor','476A73',.74,.37,wear=True)
gold=material('V3 / brushed bronze trim','B39663',.76,.34,wear=True)
bronze=material('V3 / dark bronze mechanics','72624E',.78,.33)
frame=material('V3 / machined graphite','42464C',.78,.34,wear=True)
steel=material('V3 / exposed alloy','869196',.86,.29,wear=True)
black=material('V3 / recessed black','111A23',.56,.37)
mouth=material('V3 / mask satin titanium','5D706E',.61,.42,wear=True)
blueglass=material('V3 / optical blue glass','286AB0',.25,.10,.12,.66)
eye=material('V3 / ice optics','69BEEA',.25,.15,.65,.28)
amber=material('V3 / amber optical emitter','EBB640',.36,.25,1.6)
cyan=material('V3 / cyan status emitter','50DADD',.3,.3,1.7)
mark=material('V3 / micro stencil','A4AFB0',.12,.5)
